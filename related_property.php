...
<div class="row related_property">
					<div class="row title">Related Property Batam</div>
					<div class="row subtitle">Look at our latest property, we will do the best serve for customers satisfy.</div>
					<div class="related_property_container">
						...
						<?php 
							if($category == 0){
								...
								foreach ($NewPropertys as $NewProperty) {
									...
									echo '</a>';
									echo '<div class="related_property_title">'.$NewProperty->Title.'</div>';
									echo '<div class="related_property_detail">';
							...
							elseif($category == 1){
								$Conn = Connection::get_DefaultConnection();
								$SecondaryPropertys = SecondaryProperty::LoadCollection($Conn, "Active = 1", "rand()");
								foreach ($SecondaryPropertys as $SecondaryProperty) {
									...
									echo '</a>';
									echo '<div class="related_property_title">'.$SecondaryProperty->Title.'</div>';
									echo '<div class="related_property_detail">';
							...
							elseif($category == 2){
								$Conn = Connection::get_DefaultConnection();
								$RentPropertys = RentProperty::LoadCollection($Conn, "Active = 1", "rand()");
								foreach ($RentPropertys as $RentProperty) {
									...
									echo '</a>';
									echo '<div class="related_property_title">'.$RentProperty->Title.'</div>';
									echo '<div class="related_property_detail">';
							...
							elseif($category == 3){
								$Conn = Connection::get_DefaultConnection();
								$Lands = Land::LoadCollection($Conn, "Active = 1", "rand()");
								foreach ($Lands as $Land) {
									...
									echo '</a>';
									echo '<div class="related_property_title">'.$Land->Title.'</div>';
									echo '<div class="related_property_detail">';
							...
							elseif($category == 4){
								...
								while ($Records = mysqli_fetch_array($Datas)){
									...
									echo '</a>';
									echo '<div class="related_property_title">'.$Records["Title"].'</div>';
									echo '<div class="related_property_detail">';
						...
						<div>
							...
							<div class="related_property_title">Royal Grande</div>
							<div class="related_property_detail">
