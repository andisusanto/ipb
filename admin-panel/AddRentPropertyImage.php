    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add RentProperty Image</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="RentPropertyImage.php?Id=<?php echo $RentPropertyId ?>" class="btn btn-inverse btn-mini">Back to RentProperty Image</a></h4>
                            </div>
                            <div class="w-box-content">
                                
                                <form id="validate_field_types" method="post" action="ProcessAddRentPropertyImage.php" enctype="multipart/form-data">
	                                <input type="hidden" name="RentPropertyId" value="<?php echo $RentPropertyId ?>" />
