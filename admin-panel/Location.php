                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddLocation.php" class="btn btn-inverse btn-mini" title="View">New Location</a>
                            </div>
                                    ...
                                    <?php
	                                        ...
	                                        $Name = $Location->Name;
                                                ...
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="EditLocation.php?Id='.$Id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteLocation.php?Id='.$Id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
