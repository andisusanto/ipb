                    ...
                    <div class="span12">
                        <?php 
                            $NewProperty = NewProperty::GetObjectByKey($Conn, $NewPropertyId);
                                            $NewPropertyMarketing_NewProperty = $NewProperty->Title;
                        ?>
                        <h4>New Property Marketing For <?php echo $NewPropertyMarketing_NewProperty ?></h4>
                                
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="NewProperty.php" class="btn btn-inverse btn-mini" title="View">Back to New Property</a>
                                <a href="AddNewPropertyMarketing.php?NewPropertyId=<?php echo $NewPropertyId ?>" class="btn btn-inverse btn-mini" title="View">New NewPropertyMarketing</a>
                            </div>
                            <div class="w-box-content">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $Id = $NewPropertyMarketing->get_Id();
                                            $NewPropertyMarketing_NewProperty = $NewPropertyMarketing->NewProperty;
                                            
                                            $NewPropertyMarketing_Marketing = $NewPropertyMarketing->Marketing;
                                            $Marketing = User::GetObjectByKey($Conn, $NewPropertyMarketing_Marketing);
                                            $NewPropertyMarketing_Marketing = $Marketing->Name;
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td style='width:10px'>".$counter."</td>";
                                                echo "<td style='width:800px'>".$NewPropertyMarketing_Marketing."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="ProcessDeleteNewPropertyMarketing.php?Id='.$Id.'&NewPropertyId='.$NewPropertyId.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
