...
$Newss = News::LoadCollection($conn);
                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddNews.php" class="btn btn-inverse btn-mini" title="View">New News</a>
                            </div>
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            foreach ($Newss as $News) {
                                                ...
                                                if ($News->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td>".$counter."</td>";
                                                echo "<td style='width:60px'><img alt='' src='../images/News/".$ImageName."' style='height:50px;width:50px'></td>";
                                                echo "<td>".$Title."</td>";
                                                echo "<td>".$NewsDate."</td>";
                                                echo "<td>".$Active."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="EditNews.php?Id='.$id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteNews.php?Id='.$id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
