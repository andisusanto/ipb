...
$Advertisement = Advertisement::GetObjectByKey($Conn, $Id);
$Link = $Advertisement->Link;
$ImageName = $Advertisement->ImageName;
$DueDate = $Advertisement->DueDate;
$ShowOnHome = $Advertisement->ShowOnHome;
$ShowOnContact = $Advertisement->ShowOnContact;
$ShowOnNewPropertyListing = $Advertisement->ShowOnNewPropertyListing;
$ShowOnSecondaryPropertyListing = $Advertisement->ShowOnSecondaryPropertyListing;
$ShowOnRentPropertyListing = $Advertisement->ShowOnRentPropertyListing;	
$ShowOnLandForSaleListing = $Advertisement->ShowOnLandForSaleListing;
                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="Advertisement.php" class="btn btn-inverse btn-mini">Back to Advertisement</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditAdvertisement.php" enctype="multipart/form-data">
	                                <div class="formSep">
                                        <input type="hidden" name="Id" value="<?php echo $Id; ?>">
	                                    <div class="fileupload fileupload-new" data-provides="fileupload">
	                                    	<div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
	                                        	<img src="../images/Advertisements/<?php echo $ImageName; ?>" width="150" height="150" " alt="">
	                                        </div>
	                                ...
	                                <div class="formSep">
	                                    <label class="req">Enter a URL</label>
	                                	<input value="http://" required class="span10" type="text" name="Link" id="Link" value="<?php echo $Link; ?>" />
	                                </div>

	                                <div class="formSep" >
                                        <label>Due Date</label>
                                        <input class="span10" value="<?php echo $DueDate; ?>" data-date-format="yyyy-mm-dd" id="dp1" type="text" name="DueDate">
                                    ...
                                    <div class="formSep" style="min-height: 50px;">
                                    	...
                                    	<div class="span3">
	                                        ...
	                                        <input type="checkbox" name="ShowOnHome" <?php if($ShowOnHome==1){echo "Checked";}else{echo "";} ?>/>
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On Contact</label>
	                                        <input type="checkbox" name="ShowOnContact" <?php if($ShowOnContact==1){echo "Checked";}else{echo "";} ?>/>
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On New Property</label>
	                                        <input type="checkbox" name="ShowOnNewPropertyListing" <?php if($ShowOnNewPropertyListing==1){echo "Checked";}else{echo "";} ?>/>
	                               	...
	                               	<div class="formSep" style="min-height: 50px;">
                                    	...
                                    	<div class="span3">
	                                        <label>Show On Secondary Property</label>
	                                        <input type="checkbox" name="ShowOnSecondaryPropertyListing" <?php if($ShowOnSecondaryPropertyListing==1){echo "Checked";}else{echo "";} ?>/>
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On Rent Property</label>
	                                        <input type="checkbox" name="ShowOnRentPropertyListing" <?php if($ShowOnRentPropertyListing==1){echo "Checked";}else{echo "";} ?>/>
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On Land</label>
	                                        <input type="checkbox" name="ShowOnLandForSaleListing" <?php if($ShowOnLandForSaleListing==1){echo "Checked";}else{echo "";} ?>/>
