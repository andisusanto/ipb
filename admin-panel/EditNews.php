                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="News.php" class="btn btn-inverse btn-mini">Back to News</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditNews.php" enctype="multipart/form-data">
	                                <div class="formSep">
                                        <input type="hidden" name="Id" value="<?php echo $Id; ?>">
	                                    <div class="fileupload fileupload-new" data-provides="fileupload">
	                                    	<div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
	                                        	<img src="../images/News/<?php echo $ImageName; ?>" width="150" height="150" " alt="">
	                                        </div>
                                    ...
                                    <div class="formSep">
                                        ...
                                        <Textarea class="span10" cols="70" rows="3" name="Description" id="Description"><?php echo $Description ?></Textarea>
                                    </div>
	                                <div class="formSep" >
                                        <label>News Date</label>
                                        <input class="span10" value="<?php echo $NewsDate; ?>" data-date-format="yyyy-mm-dd" id="dp1" type="text" name="NewsDate">
