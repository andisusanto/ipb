...
$Title = $RentProperty->Title;
    ...
    $RentProperty_Currency = $RentProperty->Currency;
    $Price = $RentProperty->Price;
    $Bedroom = $RentProperty->Bedroom;
    $Bathroom = $RentProperty->Bathroom;
    $LandArea = $RentProperty->LandArea;
    $BuildingArea = $RentProperty->BuildingArea;
    $FunitureIncluded = $RentProperty->FunitureIncluded;
    $RentProperty_Location = $RentProperty->Location;
    $MapImage = $RentProperty->MapImage;
    $RentProperty_Marketing = $RentProperty->Marketing;
    $Featured = $RentProperty->Featured;
    $Active = $RentProperty->Active;
?>
    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Edit Rent Property</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="RentProperty.php" class="btn btn-inverse btn-mini">Back to RentProperty</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditRentProperty.php" enctype="multipart/form-data">
                                        ...
                                        <div class="span3">
                                            ...
                                            <select class="span10" name="Currency" id="Currency">
                                                ...
                                                foreach ($Currencys as $Currency) {
                                                    if($RentProperty_Currency==$Currency->get_Id()){
                                                        $isSelected = 'selected';
                                                    }else{
                                                        $isSelected = '';
                                                    }
                                    ...
                                    <div class="formSep">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                <img src="../images/RentPropertys/<?php echo $MapImage ?>" alt="">
                                            </div>
                                        ...
                                        <select class="span10" name="Marketing" id="Marketing">
                                           <?php
                                                ...
                                                foreach ($Marketings as $Marketing) {
                                                    if($RentProperty_Marketing==$Marketing->get_Id()){
                                                        $isSelected = 'selected';
                                                    }else{
                                                        $isSelected = '';
                                                    }
