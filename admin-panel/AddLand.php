                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            ...
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddLand.php" enctype="multipart/form-data">
                                    ...
                                    <div class="formSep">
                                        ...
                                        <div class="span8">
                                            ...
                                            <input class="span10" type="text" name="Price" id="Price"  />
                                        </div>
                                    </div>
                                        ...
                                        <select class="span10" name="LandType" id="LandType">
                                            <?php
                                                ...
                                                foreach ($LandTypes as $LandType) {
                                                    echo "<option value=".$LandType->get_Id()." required>".$LandType->Name."</option>";
                                                }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="formSep">
                                     ...
                                     <div class="formSep" style="min-height: 50px;">
                                        ...
                                        <div class="span3">
                                            <label>WTO</label>
                                            <input type="text" name="WTO" id="WTO"  />
                                        ...
                                        <select class="span10" name="Marketing" id="Marketing">
                                           <?php
                                                ...
                                                foreach ($Users as $User) {
                                                    echo "<option value=".$User->get_Id()." required>".$User->Name."</option>";
                                                }
                                            ?>
                                        </select>
                                    </div>
