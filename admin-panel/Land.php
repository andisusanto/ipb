...
$Lands = Land::LoadCollection($conn);
                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddLand.php" class="btn btn-inverse btn-mini" title="View">New Land</a>
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            foreach ($Lands as $Land) {
                                                ...
                                                if ($Land->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;
                                                ...
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="LandImage.php?Id='.$Id.'" class="btn btn-mini" title="Manage Image"><i class="icon-camera"></i></a>
                                                            <a href="EditLand.php?Id='.$Id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteLand.php?Id='.$Id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
