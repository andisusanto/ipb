    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add NewProperty Image</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="NewPropertyImage.php?Id=<?php echo $NewPropertyId ?>" class="btn btn-inverse btn-mini">Back to NewProperty Image</a></h4>
                            </div>
                            <div class="w-box-content">
                                
                                <form id="validate_field_types" method="post" action="ProcessAddNewPropertyImage.php" enctype="multipart/form-data">
