...
$Facilitys = Facility::LoadCollection($Conn);
    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add New Property Facility</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="NewProperty.php" class="btn btn-inverse btn-mini">Back to New Property</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddNewPropertyFacility.php" enctype="multipart/form-data">
	                                <input type="hidden" name="NewPropertyId" value="<?php echo $NewPropertyId ?>" />
                                    <div class="formSep">
                                        <div class="span3">
                                            <label class="req">Facility</label>
                                            <select class="span10" name="Facility" id="Facility">
                                               <?php
                                                    foreach ($Facilitys as $Facility) {
                                                        echo "<option value=".$Facility->get_Id()." required>".$Facility->Name."</option>";
                                                    }
                                                ?>
                                            </select>
                                        </div>
