...
$Title = $Land->Title;
    ...
    $Land_LandType = $Land->LandType;
    $Area = $Land->Area;
    $Category = $Land->Category;
    $Conditions = $Land->Conditions;
    $WTO = $Land->WTO;  
    $MapImage = $Land->MapImage;
    $Certificate = $Land->Certificate;
    $Land_Marketing = $Land->Marketing;
                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="Land.php" class="btn btn-inverse btn-mini">Back to Land</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditLand.php" enctype="multipart/form-data">
                                        ...
                                        <div class="span3">
                                            ...
                                            <select class="span10" name="Currency" id="Currency">
                                                ...
                                                foreach ($Currencys as $Currency) {
                                                    if($Land_Currency==$Currency->get_Id()){
                                                        $isSelected = 'selected';
                                                    }else{
                                                        $isSelected = '';
                                                    }
                                    ...
                                    <div class="formSep">
                                        <label class="req">LandType</label>
                                        <select class="span10" name="LandType" id="LandType">
                                             <?php
                                                $LandTypes = LandType::LoadCollection($Conn);
                                                foreach ($LandTypes as $LandType) {
                                                    if($Land_LandType==$LandType->get_Id()){
                                                        $isSelected = 'selected';
                                                    }else{
                                                        $isSelected = '';
                                                    }
                                                    echo "<option value=". $LandType->get_Id() ." ".  $isSelected .">". $LandType->Name ."</option>";
                                                }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="formSep">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                <img src="../images/Lands/<?php echo $MapImage ?>" alt="">
                                            </div>
                                    ...
                                    <div class="formSep">
                                        <div class="span3">
                                            <label class="req">Condition</label>
                                            <input type="text" name="Conditions" id="Conditions" value="<?php echo $Conditions ?>"  />
                                        </div>
                                        <div class="span3">
                                     ...
                                     <div class="formSep" style="min-height: 50px;">
                                        ...
                                        <div class="span3">
                                            <label>WTO</label>
                                            <input type="text" name="WTO" id="WTO" value="<?php echo $WTO ?>" />
                                            
                                        </div>
                                        <div class="span3">
                                            <label class="req">Certificate</label>
                                            <input type="text" name="Certificate" id="Certificate" value="<?php echo $Certificate ?>" />
                                        </div>
                                    </div>
                                        ...
                                        <select class="span10" name="Marketing" id="Marketing">
                                           <?php
                                                ...
                                                foreach ($Marketings as $Marketing) {
                                                    if($Land_Marketing==$Marketing->get_Id()){
                                                        $isSelected = 'selected';
                                                    }else{
                                                        $isSelected = '';
                                                    }
