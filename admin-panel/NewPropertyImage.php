...
$NewPropertyImages = NewPropertyImage::LoadCollection($Conn, 'NewProperty ='.$NewPropertyId);
    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>New Property Image</h4>
                                
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="NewProperty.php" class="btn btn-inverse btn-mini" title="View">Back to New Property</a>
                                <a href="AddNewPropertyImage.php?NewPropertyId=<?php echo $NewPropertyId ?>" class="btn btn-inverse btn-mini" title="View">New NewPropertyImage</a>
                            </div>
                            <div class="w-box-content">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $Id = $NewPropertyImage->get_Id();
                                            $NewPropertyImage_NewProperty = $NewPropertyImage->NewProperty;
                                            $NewProperty = NewProperty::GetObjectByKey($Conn, $NewPropertyImage_NewProperty);
                                            $NewPropertyImage_NewProperty = $NewProperty->Title;
                                            $ImageName = $NewPropertyImage->ImageName;
                                            $Active = $NewPropertyImage->Active;
                                            if ($NewPropertyImage->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td style='width:10px'>".$counter."</td>";
                                                echo "<td style='width:60px'><img alt='' src='../images/NewPropertys/".$ImageName."' style='height:50px;width:50px'></td>";
                                                echo "<td>".$Active."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="ProcessDeleteNewPropertyImage.php?Id='.$Id.'&NewPropertyId='.$NewPropertyId.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
