    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add Secondary Property Image</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="SecondaryPropertyImage.php?Id=<?php echo $SecondaryPropertyId ?>" class="btn btn-inverse btn-mini">Back to Secondary Property Image</a></h4>
                            </div>
                            <div class="w-box-content">
                                
                                <form id="validate_field_types" method="post" action="ProcessAddSecondaryPropertyImage.php" enctype="multipart/form-data">
	                                <input type="hidden" name="SecondaryPropertyId" value="<?php echo $SecondaryPropertyId ?>" />
