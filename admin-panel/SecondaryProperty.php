...
$SecondaryPropertys = SecondaryProperty::LoadCollection($conn);
                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddSecondaryProperty.php" class="btn btn-inverse btn-mini" title="View">New Secondary Property</a>
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            foreach ($SecondaryPropertys as $SecondaryProperty) {
                                                $Id = $SecondaryProperty->get_Id();
                                                $Title = $SecondaryProperty->Title;
                                                $Description = $SecondaryProperty->Description;
                                                if ($SecondaryProperty->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;
                                                ...
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="SecondaryPropertyImage.php?Id='.$Id.'" class="btn btn-mini" title="Manage Image"><i class="icon-camera"></i></a>
                                                            <a href="EditSecondaryProperty.php?Id='.$Id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteSecondaryProperty.php?Id='.$Id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
