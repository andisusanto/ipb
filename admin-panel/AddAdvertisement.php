                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            ...
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddAdvertisement.php" enctype="multipart/form-data">
	                                <div class="formSep">
	                                ...
	                                <div class="formSep">
	                                	...
	                                	<input value="http://" required class="span10" type="text" name="Link" id="Link"  />
	                                </div>

	                                <div class="formSep" >
                                        <label>Due Date</label>
                                        <input class="span10" value="2014-11-20" data-date-format="yyyy-mm-dd" id="dp1" type="text" name="DueDate">
                                    ...
                                    <div class="formSep" style="min-height: 50px;">
	                                    ...
	                                    <div class="span3">
	                                        ...
	                                        <input type="checkbox" name="ShowOnContact" />
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On New Property</label>
	                                        <input type="checkbox" name="ShowOnNewPropertyListing" />
	                               	...
	                               	<div class="formSep" style="min-height: 50px;">
                                    	...
                                    	<div class="span3">
	                                        ...
	                                        <input type="checkbox" name="ShowOnSecondaryPropertyListing" />
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On Rent Property</label>
	                                        <input type="checkbox" name="ShowOnRentPropertyListing" />
	                                        
	                                    </div>
	                                    <div class="span3">
	                                        <label>Show On Land</label>
	                                        <input type="checkbox" name="ShowOnLandForSaleListing" />
