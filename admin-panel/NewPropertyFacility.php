                    ...
                    <div class="span12">
                        <?php 
                            $NewProperty = NewProperty::GetObjectByKey($Conn, $NewPropertyId);
                                            $NewPropertyFacility_NewProperty = $NewProperty->Title;
                        ?>
                        <h4>New Property Facility For <?php echo $NewPropertyFacility_NewProperty ?></h4>
                                
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="NewProperty.php" class="btn btn-inverse btn-mini" title="View">Back to New Property</a>
                                <a href="AddNewPropertyFacility.php?NewPropertyId=<?php echo $NewPropertyId ?>" class="btn btn-inverse btn-mini" title="View">New NewPropertyFacility</a>
                            </div>
                            <div class="w-box-content">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $Id = $NewPropertyFacility->get_Id();
                                            $NewPropertyFacility_NewProperty = $NewPropertyFacility->NewProperty;
                                            
                                            $NewPropertyFacility_Facility = $NewPropertyFacility->Facility;
                                            $Facility = Facility::GetObjectByKey($Conn, $NewPropertyFacility_Facility);
                                            $NewPropertyFacility_Facility = $Facility->Name;
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td style='width:10px'>".$counter."</td>";
                                                echo "<td style='width:800px'>".$NewPropertyFacility_Facility."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="ProcessDeleteNewPropertyFacility.php?Id='.$Id.'&NewPropertyId='.$NewPropertyId.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
