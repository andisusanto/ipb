                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="Facility.php" class="btn btn-inverse btn-mini">Back to Facility</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditFacility.php" enctype="multipart/form-data">
	                                <input type="hidden" name="Id" value="<?php echo $Id; ?>">
                                    <div class="formSep">
	                                    <label class="req">Code</label>
	                                	<input required class="span10" type="text" name="Code" id="Code" value="<?php echo $Code; ?>" />
	                                </div>

	                                <div class="formSep">
	                                    <label class="req">Link</label>
	                                	<input required class="span10" type="text" name="Name" id="Name" value="<?php echo $Name; ?>" />
	                                </div>
