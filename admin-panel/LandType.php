                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddLandType.php" class="btn btn-inverse btn-mini" title="View">New LandType</a>
                            </div>
                                    ...
                                    <?php
	                                        ...
	                                        $Name = $LandType->Name;
                                                ...
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="EditLandType.php?Id='.$Id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteLandType.php?Id='.$Id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
