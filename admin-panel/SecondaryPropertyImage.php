...
$SecondaryPropertyImages = SecondaryPropertyImage::LoadCollection($Conn, 'SecondaryProperty ='.$SecondaryPropertyId);
    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>SecondaryPropertyImage</h4>
                                
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="SecondaryProperty.php" class="btn btn-inverse btn-mini" title="View">Back to Secondary Property</a>
                                <a href="AddSecondaryPropertyImage.php?SecondaryPropertyId=<?php echo $SecondaryPropertyId ?>" class="btn btn-inverse btn-mini" title="View">New SecondaryPropertyImage</a>
                            </div>
                            <div class="w-box-content">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $Id = $SecondaryPropertyImage->get_Id();
                                            $SecondaryPropertyImage_SecondaryProperty = $SecondaryPropertyImage->SecondaryProperty;
                                            $SecondaryProperty = SecondaryProperty::GetObjectByKey($Conn, $SecondaryPropertyImage_SecondaryProperty);
                                            $SecondaryPropertyImage_SecondaryProperty = $SecondaryProperty->Title;
                                            $ImageName = $SecondaryPropertyImage->ImageName;
                                            $Active = $SecondaryPropertyImage->Active;
                                            if ($SecondaryPropertyImage->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td style='width:10px'>".$counter."</td>";
                                                echo "<td style='width:60px'><img alt='' src='../images/SecondaryPropertys/".$ImageName."' style='height:50px;width:50px'></td>";
                                                echo "<td>".$Active."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
