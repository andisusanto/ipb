    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add Rent Property</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="RentProperty.php" class="btn btn-inverse btn-mini">Back to Rent Property</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddRentProperty.php" enctype="multipart/form-data">
                                    ...
                                    <div class="formSep" style="min-height: 50px;">
                                        ...
                                        <div class="span3">
                                            ...
                                            <input type="checkbox" name="FunitureIncluded" />
                                            
                                        </div>
                                    </div>
                                    <div class="formSep">
                                        <div class="span3">
                                            <label class="req">Minimum Contract</label>
                                            <input type="text" name="MinimumContract" id="MinimumContract   "  />
                                        </div>
                                    </div>
                                    <div class="formSep">
