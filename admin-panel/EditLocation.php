                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="Location.php" class="btn btn-inverse btn-mini">Back to Location</a></h4>
                            </div>
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessEditLocation.php" enctype="multipart/form-data">
