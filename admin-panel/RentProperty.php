...
$RentPropertys = RentProperty::LoadCollection($conn);
                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="AddRentProperty.php" class="btn btn-inverse btn-mini" title="View">New Rent Property</a>
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            foreach ($RentPropertys as $RentProperty) {
                                                $Id = $RentProperty->get_Id();
                                                $Title = $RentProperty->Title;
                                                $Description = $RentProperty->Description;
                                                if ($RentProperty->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;
                                                ...
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="RentPropertyImage.php?Id='.$Id.'" class="btn btn-mini" title="Manage Image"><i class="icon-camera"></i></a>
                                                            <a href="EditRentProperty.php?Id='.$Id.'" class="btn btn-mini" title="Edit"><i class="icon-pencil"></i></a>
                                                            <a href="ProcessDeleteRentProperty.php?Id='.$Id.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
