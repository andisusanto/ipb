    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add New Property Marketing</h4>
                    	...
                    	<div class="w-box" id="n_fileupload">
                            ...
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddNewPropertyMarketing.php" enctype="multipart/form-data">
