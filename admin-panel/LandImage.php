...
$LandImages = LandImage::LoadCollection($Conn, 'Land ='.$LandId);
                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            <div class="w-box-header">
                                <a href="Land.php" class="btn btn-inverse btn-mini" title="View">Back to Land</a>
                                <a href="AddLandImage.php?LandId=<?php echo $LandId ?>" class="btn btn-inverse btn-mini" title="View">New LandImage</a>
                            </div>
                            <div class="w-box-content">
                                ...
                                <tbody>
                                    <?php
                                            ...
                                            $Id = $LandImage->get_Id();
                                            $LandImage_Land = $LandImage->Land;
                                            $Land = Land::GetObjectByKey($Conn, $LandImage_Land);
                                            $LandImage_Land = $Land->Title;
                                            $ImageName = $LandImage->ImageName;
                                            $Active = $LandImage->Active;
                                            if ($LandImage->Active == 1){$Active = "Active";}else{$Active = "InActive";}
                                                $counter++;

                                                echo "<tr>";
                                                echo "<td style='width:10px'>".$counter."</td>";
                                                echo "<td style='width:60px'><img alt='' src='../images/Lands/".$ImageName."' style='height:50px;width:50px'></td>";
                                                echo "<td>".$Active."</td>";
                                                echo '
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="ProcessDeleteLandImage.php?Id='.$Id.'&LandId='.$LandId.'" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                ';
                                                echo "</tr>";
