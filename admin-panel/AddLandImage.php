    ...
    <!-- main wrapper (without footer) -->    
        ...
        <!-- main content -->
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <h4>Add Land Image</h4>
                              
                    	<div class="w-box" id="n_fileupload">
                            <div class="w-box-header">
                                <h4><a href="LandImage.php?Id=<?php echo $LandId ?>" class="btn btn-inverse btn-mini">Back to Land Image</a></h4>
                            </div>
                            <div class="w-box-content">
                                
                                <form id="validate_field_types" method="post" action="ProcessAddLandImage.php" enctype="multipart/form-data">
