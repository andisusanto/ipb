                    ...
                    <div class="span12">
                    	...
                    	<div class="w-box" id="n_fileupload">
                            ...
                            <div class="w-box-content">
                                <form id="validate_field_types" method="post" action="ProcessAddNews.php" enctype="multipart/form-data">
	                                <div class="formSep">
                                    ...
                                    <div class="formSep">
                                        ...
                                        <Textarea class="span10" cols="70" rows="3" name="Description" id="Description"></Textarea>
                                    </div>
	                                <div class="formSep" >
                                        <label>News Date</label>
                                        <input class="span10" data-date-format="yyyy-mm-dd" id="dp1" type="text" name="NewsDate">
